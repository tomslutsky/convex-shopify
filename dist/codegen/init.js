...
export function runInit() {
    ...
    console.log('  1. Install @graphql-codegen/cli, @shopify/api-codegen-preset, and graphql-config.');
    console.log('  2. Write inline `#graphql` operations beside admin.graphql calls.');
    console.log('  3. Run convex-shopify codegen (add --watch during development).');
    console.log('  4. Create a token-encryption key: convex-shopify generate-key');
}
function writeOrKeep(projectRoot, filePath, content) {
